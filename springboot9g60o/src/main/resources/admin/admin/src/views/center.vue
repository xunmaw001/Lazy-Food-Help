  ...
  <div>
    ...
    >  
     <el-row>
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='peisongyuan'"  label="配送员账号" prop="peisongyuanzhanghao">
          <el-input v-model="ruleForm.peisongyuanzhanghao" readonly              placeholder="配送员账号" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="24">  
        <el-form-item v-if="flag=='peisongyuan'" label="头像" prop="touxiang">
          <file-upload
          tip="点击上传头像"
          action="file/upload"
          :limit="3"
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='peisongyuan'"  label="配送号码" prop="peisonghaoma">
          <el-input v-model="ruleForm.peisonghaoma"               placeholder="配送号码" clearable></el-input>
        </el-form-item>
      </el-col>
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
      ...
      if((!this.ruleForm.peisongyuanzhanghao)&& 'peisongyuan'==this.flag){
      ...
      if((!this.ruleForm.peisongyuanxingming)&& 'peisongyuan'==this.flag){
      ...
      if( 'peisongyuan' ==this.flag && this.ruleForm.peisonghaoma&&(!isMobile(this.ruleForm.peisonghaoma))){
