        ...
        <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
            ...
            <el-table-column width="300" :align="contents.tableAlign" 
               :header-align="contents.tableAlign"
                ...
                <el-button v-if="isAuth('dingdanxinxi','接单') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1" type="success" icon="el-icon-tickets" size="mini" @click="dingdanpeisongCrossAddOrUpdateHandler(scope.row,'cross','','dingdanzhuangtai','已配送','已配送,未配送'.split(',')[0])">{{ contents.tableBtnFont == 1?'接单':'' }}</el-button>
                <el-button v-if="isAuth('dingdanxinxi','接单') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2" type="success" size="mini" @click="dingdanpeisongCrossAddOrUpdateHandler(scope.row,'cross','','dingdanzhuangtai','已配送','已配送,未配送'.split(',')[0])">{{ contents.tableBtnFont == 1?'接单':'' }}<i class="el-icon-tickets el-icon--right" /></el-button>
                <el-button v-if="isAuth('dingdanxinxi','接单') && contents.tableBtnIcon == 0" type="success" size="mini" @click="dingdanpeisongCrossAddOrUpdateHandler(scope.row,'cross','','dingdanzhuangtai','已配送','已配送,未配送'.split(',')[0])">{{ contents.tableBtnFont == 1?'接单':'' }}</el-button>
