      ...
      <div class="login-form">
		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<!-- <div v-if="tableName=='peisongyuan'" class="input-group">
			   <div class="label">配送员账号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.peisongyuanzhanghao" class="input" type="text" placeholder="配送员账号">
			   </div>
			 </div> -->
			<el-form-item label="配送员账号" class="input" v-if="tableName=='peisongyuan'">
			  <el-input v-model="ruleForm.peisongyuanzhanghao" autocomplete="off" placeholder="配送员账号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='peisongyuan'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
			...
			<el-form-item label="确认密码" class="input" v-if="tableName=='peisongyuan'">
			  <el-input v-model="ruleForm.mima2" autocomplete="off" placeholder="确认密码" type="password"/>
			</el-form-item>
			...
			<!-- <div v-if="tableName=='peisongyuan'" class="input-group">
			   <div class="label">配送号码</div>
			   <div class="input-container">
			     <input v-model="ruleForm.peisonghaoma" class="input" type="text" placeholder="配送号码">
			   </div>
			 </div> -->
			<el-form-item label="配送号码" class="input" v-if="tableName=='peisongyuan'">
			  <el-input v-model="ruleForm.peisonghaoma" autocomplete="off" placeholder="配送号码"  />
			</el-form-item>
