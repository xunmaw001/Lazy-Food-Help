...
public class PeisongyuanController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		PeisongyuanEntity user = peisongyuanService.selectOne(new EntityWrapper<PeisongyuanEntity>().eq("peisongyuanzhanghao", username));
    ...
    public R register(@RequestBody PeisongyuanEntity peisongyuan){
    	...
    	PeisongyuanEntity user = peisongyuanService.selectOne(new EntityWrapper<PeisongyuanEntity>().eq("peisongyuanzhanghao", peisongyuan.getPeisongyuanzhanghao()));
		if(user!=null) {
